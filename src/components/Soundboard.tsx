...
const Soundboard: React.FC<SoundboardProps> = ({ isHost, onPlaySfx, sounds, ambienceTracks, onAmbienceChange, ambienceState, isOpen, onToggle }) => {
  ...
  return (
    <>
      ...
      <div 
        className={`fixed right-0 top-0 bottom-0 w-full md:w-[500px] bg-rpg-dark/95 border-l-2 border-rpg-accent shadow-2xl transform transition-transform duration-300 z-30 p-4 pt-20 pr-4 md:pr-24 overflow-y-auto backdrop-blur-sm ${
